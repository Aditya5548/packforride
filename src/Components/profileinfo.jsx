      ...
      <div className='flex justify-center items-center h-full'>
        <div className=' flex flex-col w-9/10 md:w-[300px] py-2 bg-gray-200 shadow-lg'>
          ...
          <div className='flex flex-col px-3 py-2 gap-2'>
            <p className='flex items-center gap-2'><User/> {data.name}</p>
            <p className='flex items-center gap-2'><Calendar/>{data.dob}</p>
            <p className='flex items-center gap-2'><Users/>{data.gender}</p>
            <p className='flex items-center gap-2'><PhoneCall/>{data.phoneno}</p>
            <p className='flex items-center gap-2'><Mail/>{data.email}</p>
          </div>
